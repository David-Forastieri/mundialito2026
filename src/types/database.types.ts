  ...
  public: {
    Tables: {
      advance_predictions: {
        ...
        Relationships: [
          {
            foreignKeyName: "advance_predictions_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
      ...
      group_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_group_member_template"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "prediction_templates"
            referencedColumns: ["id"]
      ...
      match_scores: {
        ...
        Relationships: [
          {
            foreignKeyName: "match_scores_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "match_scores_prediction_id_fkey"
      ...
      prediction_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "prediction_templates_cloned_from_fkey"
            columns: ["cloned_from"]
            isOneToOne: false
            referencedRelation: "prediction_templates"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "prediction_templates_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      refresh_group_totals: { Args: { p_match_id: string }; Returns: undefined }
    }
    Enums: {
      [_ in never]: never
    }
